...
public class Paddle implements Sprite, Collidable {
    ...
    public void moveLeft() {
        if (rec.getUpperLeft().getX() - step >= 0 + 15) {
            Point newUpperLeft = new Point(rec.getUpperLeft().getX() - step, rec.getUpperLeft().getY());
    ...
    public void drawOn(DrawSurface d) {
        ...
        d.fillRectangle((int) rec.getUpperLeft().getX(), (int) rec.getUpperLeft().getY(), (int) paddleW, paddleH);
    }
    ...
    public Velocity hit(Ball hitter, Point collisionPoint, Velocity currentVelocity) {
        ...
        if (collisionPoint.getY() == rec.getUpperLeft().getY()) {
            if (collisionPoint.getX() >= upperLeft.getX() && collisionPoint.getX() < p2.getX()) {
                vel = new Velocity(Velocity.fromAngleAndSpeed(300,
                        Math.sqrt(currentVelocity.getDx() * currentVelocity.getDx()
                                + currentVelocity.getDy() * currentVelocity.getDy())));
            }
            if (collisionPoint.getX() >= p2.getX() && collisionPoint.getX() < p3.getX()) {
                vel = new Velocity(Velocity.fromAngleAndSpeed(330,
                        Math.sqrt(currentVelocity.getDx() * currentVelocity.getDx()
                                + currentVelocity.getDy() * currentVelocity.getDy())));
            }
            if (collisionPoint.getX() >= p3.getX() && collisionPoint.getX() < p4.getX()) {
                vel = new Velocity(Velocity.fromAngleAndSpeed(0,
                        Math.sqrt(currentVelocity.getDx() * currentVelocity.getDx()
                                + currentVelocity.getDy() * currentVelocity.getDy())));
            }
            if (collisionPoint.getX() >= p4.getX() && collisionPoint.getX() < p5.getX()) {
                vel = new Velocity(Velocity.fromAngleAndSpeed(30,
                        Math.sqrt(currentVelocity.getDx() * currentVelocity.getDx()
                                + currentVelocity.getDy() * currentVelocity.getDy())));
            }
            if (collisionPoint.getX() >= p5.getX() && collisionPoint.getX() <= p6.getX()) {
