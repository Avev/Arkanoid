...
public class Block implements Collidable, Sprite, HitNotifier {
    ...
    public Velocity hit(Point collisionPoint, Velocity currentVelocity) {
        ...
        if (collisionPoint.equals(rec.getUpperLeft()) || collisionPoint.equals(rec.getUpperRight())
                || collisionPoint.equals(rec.getLowerLeft()) || collisionPoint.equals(rec.getLowerRight())) {
